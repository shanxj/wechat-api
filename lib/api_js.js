...
var preRequestWxCardApi = function (method, args, retryed) {
  console.log('preRequestWxCardApi');
  var that = this;
  var callback = args[args.length - 1];
...
exports.getAuthurl = function (param, callback) {
  console.log('getAuthurl');
  preRequestWxCardApi.call(this, this._getAuthurl, arguments);
};


exports._getAuthurl = function (param, callback) {
  console.log('_getAuthurl');
  var apiTicket = this.wxCardTicket.ticket;
  console.log('apiTicket:' + apiTicket);
  console.log('param:' + JSON.stringify(param));
  var that = this;
  var url = that.endpoint + '/card/invoice/getauthurl?access_token=' + that.token.accessToken;
  var timestamp = createTimestamp();
  var data = {
